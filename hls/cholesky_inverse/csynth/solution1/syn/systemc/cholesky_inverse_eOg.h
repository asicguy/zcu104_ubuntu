...
#ifndef __cholesky_inverse_eOg__HH__
#define __cholesky_inverse_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cholesky_inverse_eOg) {
    ...
    SC_CTOR(cholesky_inverse_eOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
