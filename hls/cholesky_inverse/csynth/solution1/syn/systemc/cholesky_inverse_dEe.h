...
#ifndef __cholesky_inverse_dEe__HH__
#define __cholesky_inverse_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cholesky_inverse_dEe) {
    ...
    SC_CTOR(cholesky_inverse_dEe):  ACMP_fmul_comb_U ("ACMP_fmul_comb_U") {
