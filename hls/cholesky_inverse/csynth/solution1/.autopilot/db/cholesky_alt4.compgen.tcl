...
set ID 12
set hasByteEnable 0
set MemName cholesky_alt4_L_ibkb
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename L \
    op interface \
    ports { L_address0 { O 4 vector } L_ce0 { O 1 bit } L_we0 { O 1 bit } L_d0 { O 32 vector } } \
} "
} else {
