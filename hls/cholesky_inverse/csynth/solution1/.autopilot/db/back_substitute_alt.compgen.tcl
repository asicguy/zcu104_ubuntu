...
set ID 23
set hasByteEnable 0
set MemName back_substitute_ahbi
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 4 vector } B_ce0 { O 1 bit } B_we0 { O 1 bit } B_d0 { O 32 vector } B_address1 { O 4 vector } B_ce1 { O 1 bit } B_we1 { O 1 bit } B_d1 { O 32 vector } } \
} "
} else {
